...
import org.xtext.example.mydsl.ide.contentassist.antlr.internal.InternalMathCompilerParser;
...
public class MathCompilerParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathCompilerGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTopAccess().getAlternatives_1_0(), "rule__Top__Alternatives_1_0");
			...
			builder.put(grammarAccess.getAbstractExpressionAccess().getGroup(), "rule__AbstractExpression__Group__0");
			...
			builder.put(grammarAccess.getTopAccess().getGroup_1(), "rule__Top__Group_1__0");
			builder.put(grammarAccess.getTopAccess().getGroup_1_0_0(), "rule__Top__Group_1_0_0__0");
			builder.put(grammarAccess.getTopAccess().getGroup_1_0_1(), "rule__Top__Group_1_0_1__0");
			...
			builder.put(grammarAccess.getMathExpAccess().getAbstractExpressionAssignment_0(), "rule__MathExp__AbstractExpressionAssignment_0");
			builder.put(grammarAccess.getMathExpAccess().getAbstractExpressionAssignment_1_1(), "rule__MathExp__AbstractExpressionAssignment_1_1");
			builder.put(grammarAccess.getAbstractExpressionAccess().getLabelAssignment_0(), "rule__AbstractExpression__LabelAssignment_0");
			builder.put(grammarAccess.getAbstractExpressionAccess().getExpAssignment_1(), "rule__AbstractExpression__ExpAssignment_1");
			...
			builder.put(grammarAccess.getTopAccess().getRightAssignment_1_1(), "rule__Top__RightAssignment_1_1");
